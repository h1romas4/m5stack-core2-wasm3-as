...
esp_err_t init_wasm_3dcube(void)
{
    ...
    // wasm_size * 2: TODO: Avoiding alignment violations
    uint8_t *wasm_binary = (uint8_t *)heap_caps_malloc(sizeof(uint8_t) * wasm_size * 2, MALLOC_CAP_INTERNAL);
